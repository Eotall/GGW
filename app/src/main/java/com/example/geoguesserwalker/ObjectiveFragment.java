...
public class ObjectiveFragment extends Fragment{
    ...
    private static final String ONBOARDING_COMPLETE = "complete";
    ...
    public void onResume() {
        super.onResume();
        compass_image.setVisibility(View.GONE);
         if (!PreferenceManager.getDefaultSharedPreferences(getContext()).getBoolean(ONBOARDING_COMPLETE, false )) {
             help_image_objective.setVisibility(View.VISIBLE);
             SharedPreferences.Editor sharedPreferencesEditor =
                     PreferenceManager.getDefaultSharedPreferences(getContext()).edit();
             sharedPreferencesEditor.putBoolean(
                     ONBOARDING_COMPLETE, true).apply();
         }else{
             help_image_objective.setVisibility(View.GONE);
         }
