...
//        textView.setText(String.format( this.objective.getName()));
        ...
        //Code for updating the location in La, Lo.
        ...
        */
        ...
        compass_image.setVisibility(View.INVISIBLE);
     ...
     private void connectButtons() {
         ...
         help_button = itemView.findViewById(R.id.help_button);
         ...
         hide_compass_button = itemView.findViewById(R.id.hide_compass_button);
         ...
         compass_button.setOnClickListener( v -> {
             hide_compass_button.setVisibility(View.INVISIBLE);
         });
    ...
    public void onResume() {
        super.onResume();
        compass_image.setVisibility(View.INVISIBLE);
        hide_compass_button.setVisibility(View.VISIBLE);
        //onAnimationStart();
    }
