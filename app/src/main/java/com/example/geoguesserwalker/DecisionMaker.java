...
public final class DecisionMaker {
     ...
     */
    public static boolean isCloseEnough(Objective obj, Device dev){ //TODO deprecate this, use distanceTo() instead
        return obj.distanceTo(dev.gps.location) <= DISTANCE_MARGIN;
    }

    public static double distanceTo(Objective obj, Device dev) {
        return obj.distanceTo(dev.gps.location) - DISTANCE_MARGIN;
    }
